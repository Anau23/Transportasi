...
public class GUITransportasi extends javax.swing.JFrame {
    ...
    private void btnProsesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProsesActionPerformed
        ...
        if (jenis.equals("Mobil")) {
            ...
            areaOutput.append("Jenis: Mobil\n");
            areaOutput.append("Nomor Plat: " + plat + "\n");
            areaOutput.append("Harga per Km: Rp" + harga + "\n");
            areaOutput.append("Total Harga: Rp" + mobil.hitungHarga(jarak) + "\n");
            areaOutput.append(layanan ? "Layanan termasuk supir\n" : "Tanpa layanan supir\n");

        } else {
            plat = "D 5678 MTR";
            harga = 3000;
            Motor motor = new Motor(plat, harga, layanan);
            areaOutput.append("Jenis: Motor\n");
            areaOutput.append("Nomor Plat: " + plat + "\n");
            areaOutput.append("Harga per Km: Rp" + harga + "\n");
            areaOutput.append("Total Harga: Rp" + motor.hitungHarga(jarak) + "\n");
            areaOutput.append(layanan ? "Helm disediakan\n" : "Helm tidak disediakan\n");
        }
